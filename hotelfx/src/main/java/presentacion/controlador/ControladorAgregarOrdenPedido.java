...
public class ControladorAgregarOrdenPedido implements Initializable{
	...
	public void agregarProducto() throws Exception {
		...
		if(listaPedidosEnTabla.isEmpty()) {
			...
			for(int i=0; i < listaPedidosEnTabla.size(); i++) {
				System.out.println(listaPedidosEnTabla.get(i).getNombre());
				System.out.println(prodSeleccionado);
				System.out.println("Nombre iguales? "+!listaPedidosEnTabla.get(i).getNombre().equals(prodSeleccionado));
	...
	public void editarPedido() throws Exception {
		System.out.println("idPedido " + idOrdenPedido);
		int idProd = 0;
		int cantidad = 0;
		...
		for(int i=0; i < listaPedidosEnTabla.size(); i++) {
			...
			idProd = Integer.valueOf(prodArray[0]);					
			System.out.println("id del prod "+idProd);
			
			cantidad = listaPedidosEnTabla.get(i).getCantidad();
			System.out.println("cantidad x Prod "+cantidad);
